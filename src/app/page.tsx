        ...
        <div className="relative w-full h-full gap-4 flex flex-col justify-start md:max-w-[1120px] md:m-auto md:flex-row md:gap-8">
          <div className="flex flex-col gap-8 justify-start rounded-xl bg-accent-pink px-5 py-9 ">
            ...
            <p className=" font-asteriks text-base leading-7 text-start">
              ...
              френч. Переможці отримають сертифікати та цінні призи від
              партнерів.
            </p>
              ...
              <div className="bg-primary p-5 rounded-xl md:px-10 md:pt-10 md:pb-16">
                <div className="flex items-center gap-2.5 md:gap-4">
                  <Image
                    ...
                    width={100}
                    height={100}
                    className="rounded-full h-12 w-12 object-cover md:w-[80px] md:h-[80px]"
                  />
                  <div className="flex flex-col">
                    <h3 className="text-primary-foreground text-sm font-bold uppercase md:text-lg">
                      {feedback.name}
                    </h3>
                    <h4 className="text-primary-foreground text-sm font-normal opacity-70 md:text-lg">
                      {feedback.position}
                    </h4>
                  </div>
                  <svg
