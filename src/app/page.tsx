    ...
    <>
      ...
      <section className="px-4 py-14">
        <div className="relative w-full h-full lg:max-w-[1120px] lg:m-auto lg:flex lg:flex-col">
          ...
          <div className="bg-primary px-7 py-14 rounded-xl lg:flex lg:flex-row-reverse lg:gap-16 lg:items-center lg:px-[110px]">
            <div className="w-full">
              <h3 className="text-primary-foreground uppercase text-xl font-travels font-bold lg:text-3xl">
                Готові вийти за рамки звичайного?
              </h3>
              <p className="mt-4 font-asteriks mb-7 text-base leading-7 text-start lg:mt-1 lg:mb-0 lg:text-lg">
            ...
            <Ball className="w-[95px] h-[95px] ml-auto flex flex-row-reverse lg:min-w-[162px] lg:h-[162px]" />
          </div>
        </div>
      </section>
      ...
      <section className="px-4 py-14 lg:px-0 lg:pt-36 lg:pb-5">
      ...
      <section className="px-4 py-14 flex flex-col lg:pt-36 lg:pb-5">
        <SectionTitle className="w-full px-4 lg:mb-6">Відгуки</SectionTitle>
        <Swiper
          spaceBetween={30}
          grabCursor={true}
          slidesPerView={1.25}
        ...
        >
          {
            feedbacks.map((feedback, index) => (
              <SwiperSlide key={index}>
                <div className="bg-primary p-5 rounded-xl lg:px-10 lg:pt-10 lg:pb-16">
                  <div className="flex items-center gap-2.5 lg:gap-4">
                    <Image
                      ...
                      width={100}
                      height={100}
                      className="rounded-full h-12 w-12 object-cover lg:w-[80px] lg:h-[80px]"
                    />
                    <div className="flex flex-col">
                      <h3 className="text-primary-foreground text-sm font-bold uppercase lg:text-lg">{feedback.name}</h3>
                      <h4 className="text-primary-foreground text-sm font-normal opacity-70 lg:text-lg">{feedback.position}</h4>
                    </div>
                    <svg className="hidden ml-auto lg:block" width="42" height="33" viewBox="0 0 42 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p className="mt-2.5 text-primary-foreground text-sm font-light opacity-80 lg:text-lg lg:mt-4">{feedback.text}</p>
                </div>
              </SwiperSlide>
            ))
          }
      ...
      <section className="px-4 py-14 lg:pt-36 lg:pb-5">
        <SectionTitle className="w-full px-4 lg:mb-6">Партнери</SectionTitle>
        <div className="relative w-full h-full flex flex-col gap-4 justify-start lg:max-w-[1120px] lg:m-auto">
          <div className="flex gap-2.5 lg:justify-center lg:gap-8">
            <div className="w-full h-[100px] flex items-center justify-center rounded-[20px] bg-primary lg:max-w-[160px] lg:h-[160px]">
              <Image
          ...
          <a href={links.partnerLink} className="text-primary-foreground mx-auto relative h-[54px] w-full max-w-[300px] mt-3 flex items-center justify-center border-[1px] border-[#4C4C4C] rounded-md hover:bg-primary-foreground hover:text-primary transition-all lg:mt-6">
      ...
      <footer className="px-4 pt-14 pb-7">
        <div className="relative w-full h-full flex flex-col gap-4 justify-start lg:max-w-[1120px] lg:m-auto">
          <div className="flex flex-col gap-4 justify-start mb-6 lg:flex-row">
            <div className="w-full">
              <SectionTitle className="w-full px-4 mb-2 lg:text-start lg:p-0">дані компанії</SectionTitle>
              <p className="font-normal text-base text-primary-foreground opacity-80 text-center mb-7 lg:text-start">
            ...
            <div className="w-full">
              <SectionTitle className="w-full px-4 mb-2 lg:text-start lg:p-0">Контактна точка</SectionTitle>
              <p className="font-normal text-base text-primary-foreground opacity-80 text-center mb-7 lg:text-start">
                Nail Moment <br/>
          ...
          <div className="lg:flex lg:items-center lg:justify-between lg:border-t-[1px] lg:border-t-[#4C4C4C] pt-5">
            <p className="text-center text-primary-foreground text-lg">©{new Date().getFullYear()} Всі права захищено</p>
            <p className="hidden text-lg text-center font-normal text-primary-foreground lg:block">Договір оферти</p>
          </div>
        </div>
      </footer>
    </>
