...
export default function Home() {
  ...
  return (
    <>
      ...
      <footer className="px-4 pt-14 pb-7 flex flex-col gap-4 justify-start">
        <div className="w-full">
          <SectionTitle className="w-full px-4 mb-2">дані компанії</SectionTitle>
          <p className="font-normal text-base text-primary-foreground opacity-80 text-center mb-7">
        ...
        <div className="w-full">
          <SectionTitle className="w-full px-4 mb-2">Контактна точка</SectionTitle>
          <p className="font-normal text-base text-primary-foreground opacity-80 text-center mb-7">
            Nail Moment <br/>
        ...
        <div className="w-full flex flex-col">
          <SectionTitle className="w-full px-4 mb-2">Відділ турботи</SectionTitle>
          <p className="font-normal text-base text-primary-foreground opacity-80 text-center mb-2">
            Якщо виникли питання, пишіть на:
          </p>
          <a href={`tel:${links.phoneNumber}`} className="font-bold text-base text-primary-foreground text-center mb-7">{links.phoneNumber}</a>
        </div>
        <div className="w-full border-y-[1px] border-y-[#4C4C4C] py-10">
          <div className="text-lg text-center font-normal text-primary-foreground mb-7">Договір оферти</div>
