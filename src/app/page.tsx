  ...
  return (
    <>
      ...
      <section className="px-4 py-14 flex flex-col gap-4 justify-start">
        ...
        <a href={links.partnerLink} className="text-primary-foreground mx-auto relative h-[54px] w-full max-w-[300px] mt-3 flex items-center justify-center border-[1px] border-[#4C4C4C] rounded-md hover:bg-primary-foreground hover:text-primary transition-all">
